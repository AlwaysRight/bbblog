    ...
    <div id="header">
        <div class="headerNav">
            ...
            <ul class="nav">
                ...
                <li><a href="#">修改密码</a></li>
                <li><a href="../index.php?C=User&F=login">退出</a></li>
            </ul>
    ...
    <div id="leftside">
        ...
        <div id="sidebar">
            ...
            <div class="accordion" fillSpace="sidebar">
                ...
                <div class="accordionContent">
                    <ul class="tree">
                        <li><a href="newPage1.html" target="dialog" rel="dlg_page">浏览车辆</a></li>
                        <li><a href="newPage1.html" target="dialog" rel="dlg_page2">添加车辆</a></li>
                    </ul>
                </div>
